...
export default function OnlineFavoritesPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch friends
      const friendsResponse = await fetch(`${apiUrl}/friends/online`, {
        method: 'GET',
        headers: {
      ...
      const requestsResponse = await fetch(`${apiUrl}/friend-requests/online`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="dark:text-gray-400 text-gray-600">
            Your friends in online context
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="dark:text-gray-400 text-gray-600 mb-4">
              No friends in online context yet. Start following people!
            </p>
            <Link
              href="/search/online"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {friends.map((friend) => (
              ...
              >
                ...
                <button
                  onClick={() => router.push(`/search/online/${friend.id}`)}
