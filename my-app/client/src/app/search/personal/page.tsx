    ...
    <div className="min-h-screen dark:bg-gray-900 bg-white">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="dark:bg-gray-800 bg-white border dark:border-gray-700 border-gray-200 rounded-lg p-8">
          <h1 className="text-4xl font-bold dark:text-white text-gray-900 mb-4">Personal Identity Search</h1>
          <p className="dark:text-gray-400 text-gray-600 mb-8">
            Search and discover personal identity profiles
          </p>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredIdentities.map((identity) => (
                <button
                  key={identity.id}
                  onClick={() => router.push(`/search/personal/${identity.id}`)}
                ...
                >
                  ...
                  <p className="dark:text-gray-400 text-gray-600 text-sm mb-4">Personal identity profile</p>
                  <div className="space-y-2">
                    ...
                    {identity.accountPrivacy === 'public' && (
                      <p className="dark:text-gray-300 text-gray-700 text-sm"><span className="font-semibold">Context:</span> Personal</p>
                    )}
